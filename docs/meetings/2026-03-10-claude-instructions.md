# Claude Instructions (from OpenClaw)

Implement arigato-gateway with these constraints:
- Internal network only, no external exposure.
- No authentication for now.
- Scraping execution is NOT built-in browser automation in this service; instead, OpenClaw Browser Relay performs scraping and posts normalized results to this gateway.
